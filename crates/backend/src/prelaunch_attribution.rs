    ...
    pub(crate) fn complete_required_observations(&self) {
        for (phase, parent, inclusive, reason) in [
            (
                ...
                Some("prelaunch"),
                false,
                "restore_mods_folder_if_stopped is not called by BackendState::prelaunch",
            ),
            (
                "load_content",
                Some("prelaunch"),
                false,
                "prelaunch_setup_mods exited before Instance::load_content completed",
            ),
            (
                "mods_scan",
                Some("prelaunch"),
                false,
                "prelaunch_setup_mods exited before the top-level mods scan completed",
            ),
            (
                "apply_modpack_and_collect_mods",
                Some("prelaunch"),
                false,
                "prelaunch_setup_mods exited before modpack resolution completed",
            ),
            (
                "rotate_mods_to_original_mods",
                Some("prelaunch"),
                false,
                "prelaunch_setup_mods exited before mods rotation",
            ),
            (
                "create_mods_dir",
                Some("prelaunch"),
                false,
                "prelaunch_setup_mods exited before launch mods directory creation",
            ),
            (
                "apply_copies_to_mods_dir",
                Some("prelaunch"),
                false,
                "prelaunch_setup_mods exited before immutable mod materialization",
            ),
            (
                "connector_cache_copy",
                Some("prelaunch"),
                false,
                "no .connector top-level extra entry was copied during this prelaunch",
            ),
            (
                "extras_copy",
                Some("prelaunch"),
                false,
                "no non-Connector top-level extra entry was copied during this prelaunch",
            ),
            (
                "modpack_config_yosbr",
                Some("apply_modpack_and_collect_mods"),
                true,
                "no config/yosbr modpack file was evaluated during this prelaunch",
            ),
            (
                "modpack_extra_file",
                Some("apply_modpack_and_collect_mods"),
                true,
                "no non-mods modpack extra file was evaluated during this prelaunch",
            ),
        ] {
